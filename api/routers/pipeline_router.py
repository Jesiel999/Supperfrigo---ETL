    ...
    try:
        while true:
            ...
            _ultimo_resultado = executar_pipeline_financeiro(
                ...
                data_insercao_inicial=req.data_insercao_inicial,
                data_insercao_final=req.data_insercao_final,
            )

            if len(resultado["dados"]) == 0:

                # altera o filtro
                data_insercao_inicial = proxima_data(data_insercao_inicial)
                data_insercao_final = proxima_data(data_insercao_final)
